        ...
        <aside class="sidebar right">
            ...
            <div class="profile" onclick="window.location.href='../doctor/profile/doctor_profile.php'" style="cursor: pointer;">
                ...
                <?php else: ?>
                    <?php if ($doctor['gender'] === 'Male'): ?>
                        <img src="../doctor/photo/male.png" alt="Male Default Picture">
                    <?php elseif ($doctor['gender'] === 'Female'): ?>
                        <img src="../doctor/photo/female.png" alt="Female Default Picture">
                    <?php else: ?>
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="../doctor/patient_feedback/feedback.php">Patient feedback</a></li>
                </ul>
            </nav>
