...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO appointments_patients (email, name, phone_number, age, gender, address, appointment_date, appointment_time, patient_status, department_name, doctor_name) 
