...
$sql = "SELECT first_name, last_name, gender FROM users WHERE email=?";
...
$date = date('Y-m-d');
$appointments_sql = "SELECT p.name AS patient_name, a.appointment_id, a.start_time, a.end_time, a.status 
                     FROM appointments a 
                    ...
                    <tbody>
                        <?php while ($appointment = $appointments_result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="view_appointment.php?appointment_id=<?php echo $appointment['appointment_id']; ?>">View</a> | 
                                    <a href="update_status.php?appointment_id=<?php echo $appointment['appointment_id']; ?>&status=done">Mark as Done</a> | 
                                    <a href="update_status.php?appointment_id=<?php echo $appointment['appointment_id']; ?>&status=rescheduled">Reschedule</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
