...
// Retrieve doctor's availability slots
$availability_sql = "SELECT slot_id, date, start_time, end_time, status FROM availability_slots WHERE doctor_email=?";
                    ...
                    <tbody>
                        <?php while ($availability = $availability_result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
    <a href="edit_availability.php?slot_id=<?php echo $availability['slot_id']; ?>">Edit</a> | 
    <a href="delete_availability.php?slot_id=<?php echo $availability['slot_id']; ?>" onclick="return confirm('Are you sure you want to delete this slot?')">Delete</a>
</td>
