...
$upcoming_appointment_query = "
    SELECT doctor_name, appointment_date, appointment_time, department_name
    FROM appointments_patients
    WHERE name = ? AND appointment_date >= CURDATE()
...
$counseling_history_query = "
    SELECT appointment_date, appointment_time, doctor_name, department_name, patient_status
    FROM appointments_patients
    WHERE name = ? AND department_name LIKE '%Clinic%'
...
<body>
    <div class="container">
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="../appointment booking system/index.php?email=<?php echo urlencode($_SESSION['user_id']); ?>" class="active">
                ...
                <a href="../profile photo/profile.php">
    ...
    <div class="middle">
        <div class="left">
            ...
            <?php if ($upcoming_appointment): ?>
                ...
                <p>Time: <?php echo htmlspecialchars($upcoming_appointment['appointment_time']); ?></p> <!-- Appointment Time -->
    ...
    <div class="profile-photo">
        <img src="<?php echo htmlspecialchars($profile_photo ?: 'default-photo.png'); ?>" alt="Profile Photo"> <!-- Display Profile Photo -->
    </div>
</div>
